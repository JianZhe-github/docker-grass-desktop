...
**[Get this image from Docker Hub!](https://hub.docker.com/r/jianzhe61/grass-desktop)**
...
- Set `GRASS_USERNAME` and `GRASS_PASSWORD` to your credentials created on getgrass.io. If you don't have a username and password yet, [use my referral link to sign up](https://app.grass.io/register?referralCode=mdoUst0zZ4r5FQa).
